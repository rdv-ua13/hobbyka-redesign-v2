		...
		<div class="container">
			<div class="content-page">
                ...
                <div class="content-page__container">
                    ...
                    <div class="content-page__row">
                        <div class="gap-xs">
                            <div class="h3">Основные особенности</div>
                        </div>

                        <ul class="list-reset list-default">
                            <li>Эргономичный дизайн: Скамейка выполнена в строгом стиле, что делает ее универсальным предметом мебели для любого помещения.</li>
                            <li>Прочность и долговечность: Изготовлена из качественных материалов, которые обеспечивают устойчивость и длительный срок службы.</li>
                            <li>Компактность: Отсутствие подлокотников делает скамейку более компактной, что позволяет разместить ее даже в небольших помещениях.</li>
                            <li>Удобство: Мягкое сиденье обеспечивает комфорт, а прочная конструкция выдерживает значительные нагрузки.</li>
                            <li>Удобство: Мягкое сиденье обеспечивает комфорт, а прочная конструкция выдерживает значительные нагрузки. Кстати говоря это пример контента когда он слишком длинный и не умещается в одну строку, поэтому приходится показать две</li>
                            <li>Удобство: Мягкое сиденье обеспечивает комфорт, а прочная конструкция выдерживает значительные нагрузки. Кстати говоря это пример контента когда он слишком длинный и не умещается в одну строку, но и не умещается в две, поэтому приходится показать сразу целых три строки с текстом, как бы нам этого не хотелось</li>
                        </ul>
                    </div>
                            ...
                            <div class="banner-slider banner-slider--gray basic-slider nav-none swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="main-banner">
                                            <div class="main-banner__item main-banner__descr">
                                                <div class="main-banner__title">Стул-висяк</div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="main-banner">
                                            <div class="main-banner__item main-banner__descr">
                                                <div class="main-banner__title">Скидки на новые коллекции подвесной мебели</div>
                                                <div class="main-banner__subtitle">Более 100 новых позиций в каталоге для сада и дома</div>
                                                <div class="main-banner__more">
                                                    <a class="btn-reset btn btn-primary" href="javascript:;">
                                                        <span class="text-content">Перейти к коллекции</span>
                                                    </a>
                    ...
                    <div class="content-page__row">
                        Скамейка Modern без подлокотников – это не просто мебель, это стильное решение для вашего дома. Закажите ее на Hobbyka.ru и наслаждайтесь комфортом и эстетикой каждый день!
                    </div>

                    <div class="content-page__row">
                        Скамейка Modern без подлокотников от магазина Hobbyka.ru – это идеальное сочетание современного дизайна, функциональности и комфорта. Она станет прекрасным дополнением любого интерьера, будь то гостиная, прихожая или садовая зона. Ее лаконичный дизайн и универсальность позволяют вписаться в самые разные стили оформления – от минимализма до скандинавского направления.
                    </div>
