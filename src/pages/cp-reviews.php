				...
				<div class="content-page__container">
						...
						<div class="slider-out">
                            <div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="3">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a class="content-page__nav-item active" href="javascript:;">Отзывы</a>
                                    </div>
                                    <div class="swiper-slide">
					...
					<div class="content-page__row">
                        <div class="gallery-docs">
                            <div class="gallery-docs__item">
                                <a href="javascript:;" class="gallery-docs__view">
                                    <img
                                        loading="lazy"
                                        class="image"
                                        src="img/cp-review-img-1.png"
                                        width="151"
                                        height="240"
                                        alt="Изображение блока"
                                    >
                                </a>
                                <a href="javascript:;" class="gallery-docs__title">
                                    <span class="text-content">Посмотреть</span>
