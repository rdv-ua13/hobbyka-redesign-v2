                ...
                <div class="content-page__container">
                    <div class="content-page__row">
                        <div class="slider-out">
                            <div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="4">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a class="content-page__nav-item active" href="javascript:;">Сертификаты</a>
                                    </div>
                                    <div class="swiper-slide">
                            ...
                            <div class="gallery-docs__item">
                                <a href="javascript:;" class="gallery-docs__view">
                                    <img
                                            loading="lazy"
                                            class="image"
                                            src="img/cp-certificate-img.png"
                                            width="151"
                                            height="240"
                                            alt="Изображение блока"
                                    >
