				...
				<div class="content-page__container">
					<div class="content-page__row">
						<div class="slider-out">
							<div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="0">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<a class="content-page__nav-item active" href="javascript:;">Дилерам</a>
									</div>
									<div class="swiper-slide">
                    ...
                    <div class="content-page__row">
                        <div class="img-descr img-descr--reverse">
                            ...
                            <div class="img-descr__descr">
                                <div class="gap-xs">
                                    <div class="h3">Региональным представителям</div>
                                </div>
                                <div class="gap-sm">
                                    <div class="img-descr__descr-text">
                                        <p>Компания «Хоббика» имеет обширную дилерскую сеть по всей России и за рубежом, и мы продолжаем её развивать. Мы ищем региональных представителей в регионах, где Хоббика ещё не представлена. И вы будете единственным дилером в вашем регионе!</p>
                                    </div>
                                </div>
                                <div class="gap-xs">
                                    <div class="h3">Основные требования</div>
                                </div>
                                <div class="gap-lg">
                                    <ul class="list-reset list-default">
                                        <li>Работа в сфере благоустройства территорий не менее 3-х лет</li>
                                        <li>Наличие собственного склада продукции</li>
                                        <li>Наличие сайта</li>
                                        <li>Физический офис</li>
                                    </ul>
                                </div>
                    ...
                    <div class="content-page__row">
                        <div class="gap-xs">
                            <div class="notice-msg">
                                Предоставляем хорошие условия для сотрудничества!<br>
                                Ваши предложения отправляйте, пожалуйста, на почту <a href="mailto:opt@hobbyka.ru" class="link link-tdu">opt@hobbyka.ru</a>.<br>
                                Внимание! Срочно ищем дилеров в городах: Екатеринбург, Ижевск, Новосибирск!
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-page__row">
                        <div class="gap-xs">
                            <div class="h3">Кого ищем для сотрудничества?</div>
                        </div>

                        <ul class="list-reset list-default">
                            <li>Торговые площадки</li>
                            <li>Интернет - магазины</li>
                            <li>Ландшафтным дизайнерам, архитекторам</li>
                            <li>Застройщикам, строительным компаниям, ландшафтно-проектным организациям и управляющим компаниям</li>
                            <li>Муниципальным учреждениям, паркам, школам, детским садам и т.д.</li>
                            <li>Сетевым магазинам и гипермаркетам</li>
                        </ul>
                    </div>
