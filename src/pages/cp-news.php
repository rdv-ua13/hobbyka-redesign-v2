						...
						<div class="slider-out">
							<div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="1">
								<div class="swiper-wrapper">
									...
									<div class="swiper-slide">
										<a class="content-page__nav-item active" href="javascript:;">Новости</a>
									</div>
									<div class="swiper-slide">
										<a class="content-page__nav-item" href="javascript:;">Услуги</a>
									</div>
									<div class="swiper-slide">
										<a class="content-page__nav-item" href="javascript:;">Контакты</a>
									</div>
									<div class="swiper-slide">
                            ...
                            <div class="article-list">
                                <div class="card card-article">
                                    ...
                                    <div class="card__descr">
                                        <div class="card__caption">1 августа 2025</div>
                                        <a class="card__title h3" href="javascript:;">Фотогалерея июля: преображение городских пространств</a>
                                        <div class="card__info">
                                            <span class="text-content">Июнь – разгар производства садово-парковой мебели. В это время года мы    с особенной любовью создаем места для отдыха, которые становятся настоящим украшением парков, скверов и частных дворов. Вместе мы превратим ваш двор или общественное пространство в комфортную зону, где каждый сможет найти себе место по душе</span>
                                        </div>
                                        <a href="javascript:;" class="card__act">
                                ...
                                <div class="card card-article">
                                    ...
                                    <div class="card__descr">
                                        <div class="card__caption">16 июня 2025</div>
                                        <a class="card__title h3" href="javascript:;">С любовью к отдыху: встречайте новую фотогалерею июня</a>
                                        <div class="card__info">
                                            <span class="text-content">Июнь – разгар производства садово-парковой мебели. В это время года мы    с особенной любовью создаем места для отдыха, которые становятся настоящим украшением парков, скверов и частных дворов. Вместе мы превратим ваш двор или общественное пространство в комфортную зону, где каждый сможет найти себе место по душе</span>
                                        </div>
                                        <a href="javascript:;" class="card__act">
                                ...
                                <div class="card card-article">
                                    ...
                                    <div class="card__descr">
                                        <div class="card__caption">11 июня 2025</div>
                                        <a class="card__title h3" href="javascript:;">С Днём России!</a>
                                        <div class="card__info">
                                            <span class="text-content">С Днём России! Компания Хоббика и вся наша команда от души поздравляют вас с этим важным и вдохновляющим праздником!</span>
                                        </div>
                                        <a href="javascript:;" class="card__act">
                                            <span class="text-content">Читать полностью</span>
                                            <svg class="icon icon-fill">
                                ...
                                <div class="card card-article">
                                    ...
                                    <div class="card__descr">
                                        <div class="card__caption">27 мая 2025</div>
                                        <a class="card__title h3" href="javascript:;">Весна вдохновляет на перемены - новая фотогалерея работ уже на сайте</a>
                                        <div class="card__info">
                                            <span class="text-content">Весна - время перемен, в том числе и в ландшафте городской среды. Мы рады, что можем внести свой вклад в создание комфортных и привлекательных парковых зон и улиц для жителей.</span>
                                        </div>
                                        <a href="javascript:;" class="card__act">
                                            <span class="text-content">Читать полностью</span>
                                            <svg class="icon icon-fill">
                                ...
                                <div class="card card-article">
                                    ...
                                    <div class="card__descr">
                                        <div class="card__caption">Урны, мимо которых не пройдут: новая серия «Стеллар Вуд»</div>
                                        <a class="card__title h3" href="javascript:;">Урны, мимо которых не пройдут: новая серия «Стеллар Вуд»</a>
                                        <div class="card__info">
                                            <span class="text-content">Спешим представить новинку производства - урны серии «Стеллар Вуд» в стильном дизайне. Прочные и аккуратно изготовленные, наши урны будут отличаться своим уникальным дизайном и в то же время, не нарушать ландшафт города или улицы. На выбор представлены несколько моделей урн, чтобы понравившийся вариант мог стать не только функциональным элементом, но и удачно вписаться в пространство и украсить его.</span>
                                        </div>
                                        <a href="javascript:;" class="card__act">
                                            <span class="text-content">Читать полностью</span>
                                            <svg class="icon icon-fill">
						...
						<div class="basic-hca">
							...
							<div class="basic-hca__content">
								<div class="slider-out basic-slider-wrap">
									<div class="product-category basic-slider basic-slider-overflow-visible swiper">
										<div class="swiper-wrapper">
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
										loading="lazy"
										class="image"
									...
									>
												...
												<span class="product-category__title">Защита корневой системы деревьев</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Уличное спортивное оборудование</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Распродажа уличной мебели</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Садовая и дачная мебель</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Скамейки</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Урны</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
									...
									>
												...
												<span class="product-category__title">Цветочницы и вазоны</span>
											</a>
											<a class="swiper-slide product-category__item" href="javascript:;">
								<span class="product-category__view">
									<img
								...
								<span class="product-category__view">
									...
									>
										...
										<div class="swiper-scrollbar-panel">
