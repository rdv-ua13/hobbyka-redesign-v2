						...
						<div class="slider-out">
                            <div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="2">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a class="content-page__nav-item active" href="javascript:;">Наши работы</a>
                                    </div>
                                    <div class="swiper-slide">
					...
					<div class="content-page__row">
                        <div class="gap-md-plus">
                            <div class="gallery-works">
                                <a href="javascript:;" class="gallery-works__item gallery-works__item--md" style="background-image:url('img/news-img-1.png');">
                                    <span class="gallery-works__item-title">Игровой комплекс River Camp Kids: ощути себя пиратом</span>
                                </a>
                                <a href="javascript:;" class="gallery-works__item" style="background-image:url('img/news-img-6.png');">
                                    <span class="gallery-works__item-title">Деревянные лежаки для парков в центре Москвы</span>
                                </a>
                                <a href="javascript:;" class="gallery-works__item" style="background-image:url('img/news-img-7.png');">
                                    <span class="gallery-works__item-title">Лавочки-амфитеатр для ЖК “Жилые Кварталы”</span>
                                </a>
                                <a href="javascript:;" class="gallery-works__item" style="background-image:url('img/news-img-6.png');">
                                    <span class="gallery-works__item-title">Деревянные лежаки для парков в центре Москвы</span>
                                </a>
                                ...
                                <a href="javascript:;" class="gallery-works__item gallery-works__item--lg" style="background-image:url('img/news-img-1.png');">
                                    <span class="gallery-works__item-title">Игровой комплекс River Camp Kids: ощути себя пиратом</span>
                                </a>
                            </div>
                        </div>
