                ...
                <div class="content-page__container">
                    <div class="content-page__row">
                        <div class="slider-out">
                            <div class="content-page__row content-page__nav swiper" data-cp-nav data-cp-nav-initial="5">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a class="content-page__nav-item active" href="javascript:;">Партнеры</a>
                                    </div>
                                    <div class="swiper-slide">
                    ...
                    <div class="content-page__row">
                        <div class="gallery-brand">
                            <div class="gallery-brand__item">
                                <img
                                        loading="lazy"
                                        class="image"
                                        src="img/cp-brand-img-1.png"
                                        width="100%"
                                        height="auto"
                                        alt="Изображение блока"
                                >
