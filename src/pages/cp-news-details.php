			...
			<div class="content-page content-page--details">
				<div class="content-page__container">
					<div class="content-page__row">
						...
						<h1 class="h2">Фотогалерея июля: преображение городских пространств</h1>
					</div>
					...
					<div class="content-page__row">
						<p>Весна - время перемен, в том числе и в ландшафте городской среды. Мы рады, что можем внести свой вклад в создание комфортных и привлекательных парковых зон и улиц для жителей. С помощью стильных <a href="https://hobbyka.ru/catalog/tsvetochnitsy_i_vazony_sadovoparkovye/" class="link link--blue" target="_blank">цветочниц</a> и <a href="https://hobbyka.ru/catalog/ulichnoe_i_sadovoparkovoe_osveshchenie/" class="link link--blue" target="_blank">фонарей</a> создаётся эстетическое пространство в классическом или современном исполнении, в котором приятно проводить время</p>
					</div>
					...
					<div class="content-page__row">
						<div class="img-descr">
							...
							<div class="img-descr__descr">
								<div class="gap-xs">
									<div class="h3">В парке</div>
								</div>
								<div class="gap-lg">
									<div class="img-descr__descr-text">
										<p>А удобные <a href="https://hobbyka.ru/catalog/kacheli_parkovye/" class="link link--blue" target="_blank">парковые качели</a>, <a href="https://hobbyka.ru/catalog/pavilony_i_navesy/" class="link link--blue" target="_blank">перголы и теневые навесы</a>, защищающие от солнца, дают возможность с удобством отдохнуть и насладиться созерцанием окружающей среды</p>
					...
					<div class="content-page__row">
						<div class="img-descr img-descr--reverse">
							...
							<div class="img-descr__descr">
								<div class="gap-xs">
									<div class="h3">Детские площадки</div>
								</div>
								<div class="gap-lg">
									<div class="img-descr__descr-text">
										<p>Также не забываем о грамотном оформлении <a href="https://hobbyka.ru/catalog/konteynernye_ploshchadki_dlya_tbo/" class="link link--blue" target="_blank">контейнерной площадки для ТБО</a>, которая должна соответствовать санитарным и техническим требованиям, и в том числе быть удобной для жителей и обслуживающего персонала</p>
									</div>
								</div>
								<button class="btn-reset btn" type="button">
									<span class="text-content">В каталог</span>
    ...
    <div class="container">
        <div class="basic-hca">
            <div class="basic-hca__heading">
                <div class="h3">Лучшие товары серии</div>
            </div>
            ...
            <div class="basic-hca__action">
                <a class="btn-reset btn btn-transparent-bordered-2 basic-hca__content-more" href="javascript:;">
